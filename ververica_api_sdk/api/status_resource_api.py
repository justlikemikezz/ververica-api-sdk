...
class StatusResourceApi(object):
    ...
    def get_status_using_get(self, **kwargs):  # noqa: E501
        """Check that the server is running  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_status_using_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_status_using_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_status_using_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_status_using_get_with_http_info(self, **kwargs):  # noqa: E501
        """Check that the server is running  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_status_using_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_status_using_get" % key
                )
            params[key] = val
        del params['kwargs']
